...
// Menu data is NOT fetched from any API — everything here is local.
...
/**
 * Filter menu items locally by category, diet and name.
 * @param {{category?: string, diet?: string, name?: string}} params
 */
